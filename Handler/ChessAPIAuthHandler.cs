...
namespace ChessAPI.Handler
{


    public class ChessAPIAuthHandler : AuthenticationHandler<AuthenticationSchemeOptions>
{
    private readonly IChessAPIRepo _repository;

    public ChessAPIAuthHandler(
        IChessAPIRepo repository,
